...
export const getPreviousPOW2Value = (inputValue) => {
...
export const getNextPOW2Value = (inputValue) => {
    if (checkInvalidInputs(inputValue))
        return 0;
    if (inputValue < 2)
        return 2;
...
export const getNearestPOW2Value = (inputValue) => {
    if (isPOW2Value(inputValue))
        return inputValue;
...
export const isPOW2Value = (inputValue) => {
    if (checkInvalidInputs(inputValue))
        return false;
    const previousPOW2 = calculatePreviousPOW2Value(inputValue);
    const nextPOW2 = calculateNextPOW2Value(inputValue);
